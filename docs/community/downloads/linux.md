...
<div className="dropdown dropdown--hoverable margin--sm">
  ...
  <ul className="dropdown__menu">
    <li>
      <DownloadButton className="dropdown__link" href="https://github.com/LinwoodCloud/dev_doctor/releases/download/release/linux.zip">
        Portable
      </DownloadButton>
    </li>
  </ul>
...
<div className="dropdown dropdown--hoverable margin--sm">
  ...
  <ul className="dropdown__menu">
    <li>
      <DownloadButton className="dropdown__link" href="https://github.com/LinwoodCloud/dev_doctor/releases/download/preview/linux.zip">
        Portable
      </DownloadButton>
    </li>
  </ul>
